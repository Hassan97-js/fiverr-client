...
const FiverrBusiness = () => {
  return (
    <div className=" bg-indigo-950 text-white mb-28">
      <LayoutSection className="flex flex-col xl:flex-row gap-28 min-h-max">
        <div className="left flex flex-col gap-10 flex-1 text-base">
          <div>
            <Heading1>fiverr business</Heading1>
            <Heading3 className="mb-4">A business solution designed for teams</Heading3>
            <p>Upgrade to a curated experience packed with tools and benefits, dedicated for business</p>
          </div>

          <ul className="flex flex-col gap-4 font-normal" role="list">
            <div className="flex items-center gap-3">
              <CustomIcon className="shrink-0" Icon={FaCheckCircle} aria-label="A check icon" />
        ...
        <div>
          <img className="rounded-md object-cover object-right w-full h-full" src={fiverBusinessImage} />
        </div>
      </LayoutSection>
    </div>
  );
